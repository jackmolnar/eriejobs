<div class="row process">
    <div class="container">
        <ul>
            ...
            <li class="{{ Request::path() == 'jobs/create/reader' ? 'active' : '' }}"><i class="fa fa-pencil"></i> Create ErieReader Listing ></li>
            <li class="{{ Request::path() == 'jobs/create/reader/review' ? 'active' : '' }}"><i class="fa fa-eye"></i> Review ErieReader Listing ></li>
