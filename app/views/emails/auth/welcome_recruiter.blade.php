...
<hr/>
<p>
Our goal is to continually improve the website, so if you have feedback or suggestions on how we can improve, please {{ link_to_action('PagesController@getContact', 'drop us a line.') }}
</p>
